...
const MyProjectsScreen = ({ refs }: { refs: Record<string, React.RefObject<HTMLDivElement>> }) => {
  ...
  return (
    <section
      className="grid grid-cols-12 h-[90vh] bg-darkblue gap-x-20"
      ref={ref}
    >
      <h2
        className="col-span-12 text-center text-3xl md:text-4xl text-lightblue mt-8"
        ref={refs.projects}
      >
        Proyectos
      </h2>
        ...
        <>
          ...
          <div className="col-span-8 flex items-start justify-start mr-10 lg:mr-14">
            <motion.div
              ...
              className="flex flex-col justify-start items-center w-full h-[60vh] bg-lightblue -mt-5 rounded-l-md overflow-hidden p-4"
            >
              <ImageComponents />
            </motion.div>
            <motion.div
              ...
              className="w-5 h-[62vh] bg-midblue -mt-7 rounded-tl-md rounded-bl-md"
            ></motion.div>
          </div>
        </>
      )}
